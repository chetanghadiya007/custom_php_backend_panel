			...
			<div class="page-header">
				<div class="page-header-content">
					<div class="page-title">
						<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Product Category</span></h4>
					</div>
				</div>
				<div class="breadcrumb-line">
					<ul class="breadcrumb">
						<li><a href="index"><i class="icon-home2 position-left"></i> Dashboard</a></li>
						<li class="active"><i class="fa fa-list-ul position-left"></i> Product Category</li>
					</ul>
				</div>
			</div>
			<!-- Page Content Start -->
	...
	<script>
		...
		$(document).ready(function() {
			$(function() {
                ...
                pageLength: 10,
				ajax: {
					url:"datatables/product_category",
					type:'post'
				},
				order: [[2, 'asc']],
