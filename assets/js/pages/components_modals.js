...
$(function() {
    ...
    // Load remote content
    $('#modal_resource').on('show.bs.modal', function() {
        $(this).find('.modal-body').load('modals/threatcatalog/resource.html', function() {
    ...
    $('#modal_category').on('show.bs.modal', function() {
        $(this).find('.modal-body').load('modals/threatcatalog/category.html', function() {
	 ...
	 // Load remote content
    $('#modal_help').on('show.bs.modal', function() {
        $(this).find('.modal-body').load('modals/threatcatalog/help.html', function() {
